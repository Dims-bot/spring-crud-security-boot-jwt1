...
import com.javamentor.springcrudsecuritybootfrom1.repository.RoleRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public void save(NewUserRequest newUserRequest) {
        ...
        Role adminRole = roleRepository.findByRole(ERole.ROLE_ADMIN).orElseThrow(() -> new RuntimeException("Error, Role ADMIN is not found"));
